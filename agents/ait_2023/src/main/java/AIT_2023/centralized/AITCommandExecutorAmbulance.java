...
public class AITCommandExecutorAmbulance extends CommandExecutor<CommandAmbulance> {
  ...
  public AITCommandExecutorAmbulance(
    ...
    this.extaction = mm.getExtAction("AIT.AT.CommandExecutorAmbulance.ExtActionTransport");

    this.pathPlanning = mm.getModule("AIT.AT.CommandExecutorAmbulance.PathPlanning");
  }
  ...
  public CommandExecutor calc() {
    ...
    //自身が市民をLoad中であった場合CommandAmbulanceは受け付けない
