...
public class MessageClearRequest extends StandardMessage {
    ...
    public MessageClearRequest(boolean isRadio, StandardMessagePriority sendingPriority,
    ...
    public MessageClearRequest(boolean isRadio, int senderID, int ttl, BitStreamReader bitStreamReader) {
    ...
    public String getCheckKey() {
        return String.format("Clear Request Position ID : " + this.positionID.getValue());
    }
}
