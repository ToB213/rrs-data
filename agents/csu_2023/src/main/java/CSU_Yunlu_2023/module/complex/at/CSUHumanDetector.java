            ...
            if (building.isBrokennessDefined()&&building.getBrokenness()>0){
                for (EntityID entityID : changedEntities){
                    ...
                    if (entity instanceof Civilian){
                        ...
                        if (civilian.getPosition().equals(position.getID())&&civilian.isBuriednessDefined()&&civilian.getBuriedness()==0&&civilian.isHPDefined()&&civilian.getHP()>0){
            ...
            if (building.isBrokennessDefined() && building.getBrokenness() > 0) {
                for (EntityID id : worldInfo.getChanged().getChangedEntities()) {
                    ...
                    if (e instanceof Civilian) {
                        if (((Civilian) e).getPosition().equals(agentPositionID) && (((Civilian) e).isBuriednessDefined() && ((Civilian) e).getBuriedness() <= 0)) {
