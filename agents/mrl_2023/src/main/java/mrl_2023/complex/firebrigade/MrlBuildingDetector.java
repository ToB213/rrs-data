...
import mrl_2023.complex.firebrigade.directionbased.DirectionBasedTargetSelector14;
    ...
    public MrlBuildingDetector(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        ...
        switch (si.getMode()) {
            case PRECOMPUTATION_PHASE:
                this.pathPlanning = moduleManager.getModule("ActionExtClear.PathPlanning", "adf.core.sample.module.algorithm.SamplePathPlanning");
                break;
            case PRECOMPUTED:
                this.pathPlanning = moduleManager.getModule("ActionExtClear.PathPlanning", "adf.core.sample.module.algorithm.SamplePathPlanning");
                break;
        ...
        exploreManager = moduleManager.getModule("FireBrigadeSearch.ExploreManager", "mrl_2021.complex.firebrigade.TargetBaseExploreManager");
