 ...
 *         Time: 6:49 PM
 */
public class VictimClassifier2 {
    ...
    public VictimClassifier2(WorldInfo wi, AgentInfo agentInfo) {
        this.worldInfo = wi;
...
//        }
        ...
        for (StandardEntity standardEntity : myGoodHumans) {
            ...
            if (h.isPositionDefined() && h.isHPDefined() && h.isDamageDefined() && h.isBuriednessDefined() && h.getBuriedness() == 0 && h.getHP() > 0 ) {
