 ...
 */
public class MrlAPoliceKMeans extends StaticClustering {
    ...
    public MrlAPoliceKMeans(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
...
//        this.assignAgentsFlag = developData.getBoolean("sample.module.SampleKMeans.assignAgentsFlag", true);
    ...
    private void calcStandard() {
        ...
        Collection<StandardEntity> policeAgents = worldInfo.getEntitiesOfType(StandardEntityURN.AMBULANCE_TEAM);
