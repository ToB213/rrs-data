...
import mrl_2023.complex.firebrigade.FireBrigadeUtilities;
...
import mrl_2023.world.entity.MrlRoad;
...
//        visibleFromAreas = new HashMap<>();
        switch (scenarioInfo.getMode()) {
            case PRECOMPUTATION_PHASE:
                this.pathPlanning = moduleManager.getModule("ActionFireFighting.PathPlanning", "adf.core.sample.module.algorithm.SamplePathPlanning");
//                this.clustering = moduleManager.getModule("SampleBuildingDetector.Clustering", "adf.core.sample.module.algorithm.SampleKMeans");
