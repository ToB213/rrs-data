...
import mrl_2023.algorithm.SamplePathPlanning;
import mrl_2023.extaction.move.RayMoveActExecutor;
    ...
    public ActionExtMove(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, DevelopData developData) {
        ...
        switch (scenarioInfo.getMode()) {
            case PRECOMPUTATION_PHASE:
                this.pathPlanning = moduleManager.getModule("DefaultExtActionMove.PathPlanning", "adf.impl.module.algorithm.AStarPathPlanning");
                break;
            case PRECOMPUTED:
                this.pathPlanning = moduleManager.getModule("DefaultExtActionMove.PathPlanning", "adf.impl.module.algorithm.AStarPathPlanning");
                break;
