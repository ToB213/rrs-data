...
public class MActionTransport extends ExtAction
{
    ...
    public MActionTransport(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, DevelopData developData)
    {
        super(agentInfo, worldInfo, scenarioInfo, moduleManager, developData);
        this.target = null;
        this.thresholdRest = developData.getInteger("ActionTransport.rest", 100);

        this.pathPlanning = moduleManager.getModule("ActionTransport.PathPlanning", "adf.core.sample.module.algorithm.SamplePathPlanning");
    }
